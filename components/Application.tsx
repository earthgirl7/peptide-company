export default function Application() {
  ...
  return (
    <section className="py-16 md:py-20 bg-gray-50 dark:bg-gray-900" id="apply">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center">
          <a
            ...
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-10 py-5 rounded-lg text-xl transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
